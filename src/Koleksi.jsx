        ...
        {koleksiBuku.map((buku) => {
          ...
          return (
            <div 
              ...
              className="bg-white p-3.5 flex items-center justify-between border border-stone-100 transition-all"
            >
              ...
              {/* TOMBOL KENDALIAKSI: JIKA ADMIN TAMPILKAN LAYOUT EDIT & DELETE, JIKA TAMU TAMPILKAN IKON BUKU */}
              {isAdmin ? (
                ...
                /* Tampilan Ikon Buku Default jika dibuka sebagai Tamu */
